   ...
   ?>
         ...
         <nav>
            <ul>
               ...
               <li><a href="/mems" class="current-page">МЕМЫ</a></li>
            </ul>
         </nav>
      </div>
   </header>
...
<div class="container container-flex">
         ...
         <?php require_once("$_SERVER[DOCUMENT_ROOT]/mems/generation/post-mems.php"); ?>
         
         <div class="pagination">
         <ul>
         <?php require_once("$_SERVER[DOCUMENT_ROOT]/mems/generation/pagination.php"); ?>
         </ul>
      </div>
