   ...
   ?>
         ...
         <nav>
            <ul>
               ...
               <li><a href="/art" class="current-page">ART</a></li>
...
<div class="container container-flex">
         ...
         <?php require_once("$_SERVER[DOCUMENT_ROOT]/art/generation/post-art.php"); ?>
         
         <div class="pagination">
         <ul>
         <?php require_once("$_SERVER[DOCUMENT_ROOT]/art/generation/pagination.php"); ?>
         </ul>
      </div>
