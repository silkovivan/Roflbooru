   ...
   ?>
         ...
         <nav>
            <ul>
               ...
               <li><a href="/gifs" class="current-page">ГИФКИ</a></li>
...
<div class="container container-flex">
         ...
         <?php require_once("$_SERVER[DOCUMENT_ROOT]/gifs/generation/post-gifs.php"); ?>
         
         <div class="pagination">
         <ul>
         <?php require_once("$_SERVER[DOCUMENT_ROOT]/gifs/generation/pagination.php"); ?>
         </ul>
      </div>
